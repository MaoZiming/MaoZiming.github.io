...
My current focus is on **GPU communication**, with an emphasis on coordinating communication with computation and co-designing with higher-level frameworks. In particular, I research new **GPU communication abstractions and primitives** that enable fine-grained communication–computation overlap while preserving software flexibility, portability, and performance. I am also broadly in ML systems and networking, in the context of cloud, data, and emerging AI workloads.
