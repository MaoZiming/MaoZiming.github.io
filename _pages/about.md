...
Hey, I am Ziming! I graduated from Yale University, with double major in Computer Science and Philosophy. I will be joining UC Berkeley for Computer Science PhD. 
<!-- working with Prof. <a style="text-decoration:none" href="https://people.eecs.berkeley.edu/~istoica/" target="_blank">Ion Stoica</a> and Prof. <a style="text-decoration:none" href="https://www2.eecs.berkeley.edu/Faculty/Homepages/shenker.html" target="_blank">Scott Shenker</a>. -->
...
<!-- I am broadly interested in <span style="color:green; font-style:italic">Computer Systems and Networks</span>. I am currently working on an OS stack for memory disaggregation, and some cool project for <a style="text-decoration:none" href="https://sky.cs.berkeley.edu" target="_blank">Sky Computing</a>. -->
